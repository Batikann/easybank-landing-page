    ...
    <footer className="bg-dark-blue ">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1  md:grid-cols-4 gap-4 lg:items-start lg:justify-start items-center justify-center py-12 px-5 place-items-center">
        <div>
          ...
          <div>
            <ul className="flex justify-center items-center gap-3 my-5 md:my-12">
              <li>
                <a href="#">
                  <svg
                    ...
                    width="20"
                    height="20"
                    class="flex-none  hover:text-lime-green w-7 h-7  fill-current text-white transition-colors duration-300"
                  >
